...
def get_asset_data(symbol, asset_type, start, end):
    ...
    try:
        ...
        return None
# 可视化
def plot_kline_with_signals(df,code):
    stock_name=stock_info[stock_info['code']==code]['名称'].values[0]
    fig = go.Figure()
    # 主K线
...
def app():
    ...
    with col1:
        code = f"{code}".strip()
        st.plotly_chart(plot_kline_with_signals(analyzed_data,code), use_container_width=True)
    with col2:
        st.subheader("实时信号")
    ...
    my_stock=['002304','600515','002460','601238','002714','000977','000756','600585','300024','601360','002202']
